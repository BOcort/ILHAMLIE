...
export default function ProjectCard(props) {
    ...
    return (
        <div className="card w-96 hover:transition-shadow ease-out hover:ease-in hover:delay-300 hover:bg-opacity-80 hover:cursor-pointer active:cursor-pointer bg-gray-700 text-left shadow-xl  ">
