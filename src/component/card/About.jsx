  ...
  return (
    <div className='bg-black text-white '>
      <div id="container" className=" w-11/12 mx-auto  ">
        <div id="about-me" className="md:grid md:grid-cols-3">
          <div id="profile-picture" className="md:col-span-1 w-full">
            <img src={PhotoProfile} alt="" className='max-md:m-auto' />
          </div>
          <div id="introduce" className="md:col-span-2 grid grid-rows-1">
            ...
            <div id='Expertise' className='row-span-1 '>
              <div className='max-md:mt-6'>
                ...
                <div id='skill' className='md:grid md:grid-cols-2 gap-4'>
                  <div id='Language' className='p-3 rounded-xl border-dashed border-2 border-sky-500 max-md:m-8'>
                  ...
                  <div id='Web-programing' className='p-3 rounded-xl border-dashed border-2 border-sky-500 max-md:m-8'>
